...
class BlockingConnection:
    def __init__(
        self, parameters: connection.Parameters | Sequence[connection.Parameters] | None = ..., _impl_class: Any | None = ...
    ) -> None: ...
...
class BlockingChannel:
    ...
    ) -> tuple[spec.Basic.GetOk | None, spec.BasicProperties | None, str | None]: ...
    def basic_publish(
